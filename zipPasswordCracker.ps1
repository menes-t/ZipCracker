...
If($help -eq "h"){
    ...
    Write-Color -Text "[-dictionaryFile]: The name of dictionary file" -Color Yellow -LogFile "Log"
    Write-Color -Text "[-zipPath]: The zip file you want to crack" -Color Yellow -LogFile "Log"
    Write-Color -Text "" -Color Yellow -LogFile "Log"
    ...
    Write-Color -Text "" -Color Yellow -LogFile "Log"
    Write-Color -Text "NOTE: Please place the dictionary and zip files with the same directory of script!!!" -Color Red -BackColor Black -LogFile "Log"
    Write-Color -Text "" -Color Yellow -LogFile "Log"
	Write-Color -Text "" -Color Yellow -LogFile "Log"
    Write-Color -Text "--------------------------------------------------------------------------------------------------------" -Color Yellow -LogFile "Log"
	exit
